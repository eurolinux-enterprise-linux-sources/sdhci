%define kmod_name		sdhci
%define kmod_driver_version	0.1_rh1
%define kmod_rpm_release	1
%define kmod_git_hash		42b0cf095dfaa5e6f5a02beb78e4cdbf25d28156
%define kmod_kernel_version	2.6.32-573.el6
%define kernel_version		2.6.32-573.el6
%define kmod_kbuild_dir		drivers/mmc/host/


%{!?dist: %define dist .el6_7}
...
%changelog
* Wed Feb 17 2016 Petr Oros <poros@redhat.com> 0.1_rh1 1
- Resolves: #1302115
- sdhci DUP module
